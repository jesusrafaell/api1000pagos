...
<head>        
    ...
    <body>             
        ...
        <div class="row">
            <div id="header-form">
                <h1>Confirme la información del Tipo Pos a eliminar</h1>
            </div>
            <label class="error-message" style="align-content: center">${model.messageError}</label>
            <div id="box-form">
                <form:form method="post" autocomplete="off" commandName="eliminarTipoPos">
                      ...
                      <table class="formulario">  
                        ...
                        <tr>
                            ...
                            <td class="botonera" colspan="2">                                    
                                <input type="image" name="eliminatipopos" src="${pageContext.request.contextPath}/resources/img/actualizar.png" width='52' height='52'/>
                            </td>
                        </tr>
                      </table>                    
                    </div>  
