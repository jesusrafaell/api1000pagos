<%-- 
    Document   : guardarTerminalComercio
...
<head>        
    ...
    <body>        
        ...
        <script type="text/javascript">
            ...
            $( document ).ready(function() {
                ...
                if($('#pagoContado').val() == "1"){//equipo
                    ...
                    /*
                    $("#montoEquipoUSD").prop("disable",true);
                    $("#montoEquipoBs").prop("disable",true);
                    $("#ivaEquipoBs").prop("disable",true);
                    $("#montoTotalEquipoBs").prop("disable",true);*/
                    $(".pagoContado").hide();
                }
        ...
        <div class="row">
            <div id="header-form">
                <h1>Formulario para registrar un Terminal</h1>
            </div>
            <div id="box-form">
                <form:form method="post" autocomplete="off" commandName="guardarTerminalComercio">
                      ...
                      <table class="formulario">
                        ...
                        <tr>
                          ...
                          <tr>
                              ...
                              <td class="campo">
                                  <form:select path="tipoCuentaAbono" cssClass="select" multiple="false">
                          ...
                          <tr>
                              ...
                              <td class="campo">
                                  <form:input path="numeroCuentaAbono" cssClass="textbox" type="text" maxlength="20"/>
                              </td>
                          </tr>
                          <tr>
                              <td colspan="2">
                        ...
                        <tr>              
                            ...
                            <td></td>
                            <td>
                                <a href="listadoTerminalesComercio.htm?messageError=&codigoComercio=${guardarTerminalComercio.codigoComercio}&codBancoCuentaAbono=${guardarTerminalComercio.codigoBancoCuentaAbono}&numCuentaAbono=${guardarTerminalComercio.numeroCuentaAbono}"><img src="${pageContext.request.contextPath}/resources/img/volver.png" width='56' height='56'/></a>
                            </td>
                            <td>                                    
                                <input type="image" name="guardarTerminal" src="${pageContext.request.contextPath}/resources/img/guardar.png" width='52' height='52'/>
                            </td>
                        </tr>
                      </table>                    
                    </div>  
