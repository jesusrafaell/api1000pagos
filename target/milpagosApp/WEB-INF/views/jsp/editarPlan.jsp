...
<head>        
    ...
    <body>   
        ...
        <div class="row">
            <div id="header-form">
                <h1>Formulario para modificar un Plan de Cobranza</h1>
            </div>
            <label class="error-message" style="align-content: center">${model.messageError}</label>
            <div id="box-form">
                <form:form method="post" autocomplete="off" commandName="editarPlan">
                    <div class="contenedor_formulario">
                      ...
                      <tr>
                            ...
                            <td class="campo">
                                <form:input path="descTipoPlan" cssClass="textbox" readonly="readonly"/> 
                        ...
                        <tr>
                            <td class="etiqueta_black">
                                <form:radiobutton path="tipoPagoMantenimiento" value="montoTarifa"/>Monto Tarifa:</td>
                            <td class="campo">
                        ...
                        <tr>
                            <td class="campo">                                                                    
                                <form:checkbox path="indefinido" id="indefinido"/>
                                <br>
                        ...
                        <tr>
                            ...
                            <td class="campo">
                                 <form:input path="transaccion" cssClass="textbox" type="number" min="0" /> 
                                  <br>
                        ...
                        <tr>
                             <td class="campo">
                                 <form:input path="diasimpago" cssClass="textbox" type="number" min="0" /> 
                                 <br>
                                 <form:errors path="diasimpago" cssClass="error-message"/>
                            </td>
                           <td class="campo">
                                 <form:input path="porcentaje" cssClass="textbox" type="number" min="0" max="100"/> 
                                 <br>
                        ...
                        <tr>
                            ...
                            <td class="botonera" colspan="2">                                    
                                <input type="image" name="actualizaplan" src="${pageContext.request.contextPath}/resources/img/actualizar.png" width='52' height='52'/>
                            </td>
                        </tr>
                      </table>                    
                    </div>  
