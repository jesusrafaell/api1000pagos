...
<html>
	...
	<td colspan="2" class="titulo_tabla">
	   Bitácora Módulo de Administración
	</td>
	</tr>
	</table>
        <br>
        <display:table name="${model}" pagesize="5" requestURI="/bitacoraAdmin.htm" export="true" class="tabla" cellpadding="0" cellspacing="0" style="margin:0 auto; width:750px;">
