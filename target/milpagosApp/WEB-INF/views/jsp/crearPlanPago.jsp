...
<head>        
    ...
    <body>   
        ...
        <script type="text/javascript">
            ...
            var planes = JSON.parse('${crearPlanPago.jsonPlanes}');
            var planesActivos = JSON.parse('${crearPlanPago.jsonPlanesActivos}');
            var montoCuotasCobradas = JSON.parse('${crearPlanPago.jsonMontoCuotasCobradas}');
        ...
        <div class="row">
            <div id="header-form">
                <h1>Formulario para crear un Plan de Pago</h1>
            </div>
            <label class="error-message" style="align-content: center">${model.messageError}</label>
            <div id="box-form">
                <form:form method="post" autocomplete="off" commandName="crearPlanPago">
                      ...
                      <table class="formulario">  
                        <tr>
                            ...
                            <td class="campo" style="width: 300px;">
                                ...
                                <form:input type="hidden" path="jsonPlanesActivos"/>                               
                                <form:input type="hidden" path="jsonMontoCuotasCobradas"/>     
                            </td>        
                        </tr>
                        <tr>
                            <td colspan="2">
                        ...
                        <tr>
                            ...
                            <td class="campo">   
                                ...
                                <input type="hidden" class="textbox" id="codtipoplan" name="codtipoplan"/> 
                            </td>
                        </tr> 
                        ...
                        <tr class="tipoUso tipoMantenimiento monto-fijo-td">
                        ...
                        <tr class="tipoUso procentaje-td">
                            <td class="etiqueta_black">
                        ...
                        <tr>
                            ...
                            <td></td>
                             <td>
                               <a class="volver" href="listadoTerminalPlanes.htm?messageError=&codigoTerminal=${crearPlanPago.codigoTerminal}"><img src="${pageContext.request.contextPath}/resources/img/volver.png" class="volver" width='56' height='56'/></a>                                
                            </td>
                            <td class="botonera" colspan="2">                                    
                                <input type="image" name="crearPlanPago" id="crearPlanPagoButton" src="${pageContext.request.contextPath}/resources/img/guardar.png" width='52' height='52'/>
                            </td>
                        </tr>
                      </table>                    
                    </div>  
