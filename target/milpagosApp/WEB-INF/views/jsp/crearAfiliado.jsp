...
<head>        
    ...
    <body>  
        ...
        <div class="row">
            <div id="header-form">
                <h1>Formulario para crear un Afiliado</h1>
            </div>
            <label class="error-message" style="align-content: center">${model.messageError}</label>
            <div id="box-form">
                <form:form method="post" autocomplete="off" commandName="crearAfiliado">
                      ...
                      <table class="formulario">                                       
                        ...
                        <tr>
                            ...
                            <td class="botonera" colspan="2">                                    
                                <input type="image" name="crearAfiliado" src="${pageContext.request.contextPath}/resources/img/guardar.png" width='52' height='52'/>
                            </td>
                        </tr>
                      </table>                    
                    </div>  
